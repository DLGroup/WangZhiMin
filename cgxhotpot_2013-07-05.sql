...
# Database: cgxhotpot
# Generation Time: 2013-07-05 09:19:58 +0000
# ************************************************************
...
VALUES
	...
	(25,'Can add jobs',9,'add_jobs'),
	(26,'Can change jobs',9,'change_jobs'),
	(27,'Can delete jobs',9,'delete_jobs');
...
VALUES
	...
	(16,'2013-07-05 05:45:45',1,9,'1','洗碗',1,''),
	(17,'2013-07-05 06:20:37',1,9,'1','串根香',1,'');
...
CREATE TABLE `jobs_jobs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `jobs_name` varchar(64) NOT NULL,
  `jobs_deadline` date NOT NULL,
  `jobs_description` longtext NOT NULL,
  `jobs_salary` varchar(64) NOT NULL,
  `jobs_number` varchar(64) NOT NULL,
  `jobs_requirement` longtext NOT NULL,
  `jobs_contact` varchar(64) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `jobs_jobs` (`id`, `jobs_name`, `jobs_deadline`, `jobs_description`, `jobs_salary`, `jobs_number`, `jobs_requirement`, `jobs_contact`)
VALUES
	(1,'串根香','2013-07-23','1、全方位掌握串根香的品牌以及产品优势，负责火锅连锁加盟网上运营销售和支持，网站内容的维护等。 \r\n2、负责推广公司品牌及连锁供应的产品。 \r\n3、负责公司网上商品的内容编缉、审核和信息内容的调整； \r\n4、负责与客户的沟通，达成交易。跟进产品销售后的相关物流配送、售后服务状况；','面议','2人','1、有一定电脑操作基础，头脑灵活，学习能力强，有良好的沟通协作能力。 \r\n2、中专以上学历，熟练应用各类办公软件；熟悉Internet，具有客户服务意识和销售技巧。 \r\n3、对在线销售和电子商务具有浓厚的兴趣和遇事坚持不懈的精神； \r\n4、懂得网络销售产品，能够随机应变处理不同的客户需要和问题； \r\n5、具备良好的心理素质，工作态度积极乐观，有开拓进取精神和新客户开发能力，较强的信息收集、采编整合能力； \r\n6、熟悉，做过连销加盟和有相关行业工作经验者优先。 ','陈先生 电话：13872458971');
