...
$(function(){
	...
	$("#teachingjobBackgroud").datagrid({
		...
		columns:[[  
			...
			{field:'batch',title:'作业标题',width:100}, 
			...
			{field:'opt',title:'操作',width:116,align:'center', rowspan:2,
						formatter:function(value,rec){
							return '<span style="color:red"><a href="#">下载</a>&nbsp;<a href="../../teacher/teaching/job_score.html">评分</a>&nbsp;<a href="../../teacher/teaching/job_score.html">查看评语</a></span>';
