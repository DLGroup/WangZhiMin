...
},plugins:["linkbutton","menu","menubutton","splitbutton","progressbar","tree","combobox","combotree","numberbox","validatebox","searchbox","numberspinner","timespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window","ezdialog"],parse:function(_168){
var aa=[];
...
function _1e8(_1e9){
var t=$(_1e9);
t.wrapInner("<div class=\"ezdialog-content\"></div>");
var _1ea=t.children("div.ezdialog-content");
...
function _1eb(_1ec){
var opts=$.data(_1ec,"ezdialog").options;
var _1ed=$.data(_1ec,"ezdialog").contentPanel;
if(opts.toolbar){
if(typeof opts.toolbar=="string"){
$(opts.toolbar).addClass("ezdialog-toolbar").prependTo(_1ec);
$(opts.toolbar).show();
}else{
$(_1ec).find("div.ezdialog-toolbar").remove();
var _1ee=$("<div class=\"ezdialog-toolbar\"></div>").prependTo(_1ec);
for(var i=0;i<opts.toolbar.length;i++){
var p=opts.toolbar[i];
if(p=="-"){
_1ee.append("<div class=\"ezdialog-tool-separator\"></div>");
}else{
...
$(opts.buttons).addClass("ezdialog-button").appendTo(_1ec);
$(opts.buttons).show();
}else{
$(_1ec).find("div.ezdialog-button").remove();
var _1ef=$("<div class=\"ezdialog-button\"></div>").appendTo(_1ec);
...
_1ed.panel("resize",{width:_1f5.width(),height:(_1f4=="auto")?"auto":_1f5.height()-_1f5.find(">div.ezdialog-toolbar").outerHeight()-_1f5.find(">div.ezdialog-button").outerHeight()});
if(opts.onResize){
...
var _1f8=$.data(_1f7,"ezdialog").contentPanel;
_1f8.panel("refresh",href);
};
$.fn.ezdialog=function(_1f9,_1fa){
if(typeof _1f9=="string"){
var _1fb=$.fn.ezdialog.methods[_1f9];
if(_1fb){
...
_1f9=_1f9||{};
return this.each(function(){
var _1fc=$.data(this,"ezdialog");
if(_1fc){
$.extend(_1fc.options,_1f9);
}else{
$.data(this,"ezdialog",{options:$.extend({},$.fn.ezdialog.defaults,$.fn.ezdialog.parseOptions(this),_1f9),contentPanel:_1e8(this)});
}
_1eb(this);
});
};
$.fn.ezdialog.methods={options:function(jq){
var _1fd=$.data(jq[0],"ezdialog").options;
...
var _1ff=$.data(jq[0],"ezdialog").contentPanel;
return _1fd;
},ezdialog:function(jq){
...
$.fn.ezdialog.parseOptions=function(_200){
var t=$(_200);
return $.extend({},$.fn.window.parseOptions(_200),{toolbar:t.attr("toolbar"),buttons:t.attr("buttons")});
};
$.fn.ezdialog.defaults=$.extend({},$.fn.window.defaults,{title:"New ezdialog",collapsible:false,minimizable:false,maximizable:false,resizable:false,toolbar:null,buttons:null});
})(jQuery);
(function($){
